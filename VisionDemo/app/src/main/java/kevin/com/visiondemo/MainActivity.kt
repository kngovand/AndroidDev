...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        svBarcode.holder.addCallback(object: SurfaceHolder.Callback{
            ...
            override fun surfaceCreated(holder: SurfaceHolder?) {
                ...
                else ActivityCompat.requestPermissions(this@MainActivity, arrayOf(Manifest.permission.CAMERA), 123)
            }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        if(requestCode == 123) {
            ...
            else Toast.makeText(this, "Scanner does not work without permission", Toast.LENGTH_SHORT).show()
